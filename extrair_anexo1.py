...
# Armazenando o nome de todos os arquivos da PASTA_ZIPS na variável lista_arquivos. Obs: é armazenado no formato de lista
lista_arquivos= os.listdir(PASTA_ZIPS)
    ...
    try:
        with zipfile.ZipFile(caminho_zip, 'r') as zip_ref:
            ...
            for anexo1 in arquivos_anexo1:
                ...
                print(f"✅ Anexo1 separado e zip criado: {nome_zip}")
