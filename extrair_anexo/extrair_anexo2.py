...
for nome_zip in os.listdir(PASTA_ZIPS):
    ...
    # nome do zip SEM .zip (vai virar nome do Anexo1)
    nome_zip_base, _ = os.path.splitext(nome_zip)
        ...
        with zipfile.ZipFile(caminho_zip, 'r') as zip_ref:
            ...
            for anexo1 in arquivos_anexo1:
                ...
                with tempfile.TemporaryDirectory() as temp_dir:
                    ...
                    # Anexo1 recebe o nome do ZIP (sem .zip)
                    caminho_final = os.path.join(
                        PASTA_ANEXO1,
                        f"{nome_zip_base}{extensao}"
                    )
                    ...
                    while os.path.exists(caminho_final):
                        caminho_final = os.path.join(
                            PASTA_ANEXO1,
                            f"{nome_zip_base}_{contador}{extensao}"
                        )
                        contador += 1
                    ...
                    caminho_zip_anexo1 = os.path.join(
                        PASTA_ZIP_ANEXO1,
                        f"{os.path.splitext(os.path.basename(caminho_final))[0]}.zip"
                    )
                ...
                print(f"✅ Anexo1 renomeado para '{nome_zip_base}{extensao}' e zip criado")
